...
- **Live Cluster Topology & Node Specifications**: Real-time display of Node 1 (Primary Master, PowerDNS 4.9, MariaDB) and Node 2 (Secondary Replica, PowerDNS 4.7, SQLite3) with one-click copyable IPv4/IPv6 addresses (`77.90.60.110` & `94.249.188.145`) on AS215365.
...
- **Architectural & Deployment Showcase**: Highlights dual-node IP diversity, AXFR supermaster replication, native DNSSEC, Caddy on-demand TLS validation, and quickstart commands for Docker Compose and zero-touch VPS installation.
